...
public class Main extends SimpleApplication {
    ...
    private float grassScale = 128;
    private float brickScale = 128;
    private float roadScale = 200;
    
    TextureKey TmpHeightmap = new TextureKey();
    ...
    public void simpleInitApp() {
        setupKeys();
        List<VillageData> Settlements =  Scrapper.GetVillagesInRadius(50.75f, -3.14f, 4,this);
        
        
    	Scrapper.GetLandscapeTile(8050, 5503,this);
    	System.exit(0);
        ...
        matTerrain.setTexture("AlphaMap", assetManager.loadTexture("Textures/ColyAlphamap.png"));
        matTerrain.setTexture("AlphaMap_1", assetManager.loadTexture("Textures/ColyAlphamap.png"));
        // this material also supports 'AlphaMap_2', so you can get up to 12 diffuse textures
        
        // HEIGHTMAP image (for the terrain heightmap)
        TextureKey hmKey = new TextureKey("Textures/ColyHeightmap.png", false);
         ...
         */
        terrain = new TerrainQuad("terrain", 65, 2049, heightmap.getHeightMap());//, new LodPerspectiveCalculatorFactory(getCamera(), 4)); // add this in to see it use entropy for LOD calculations
